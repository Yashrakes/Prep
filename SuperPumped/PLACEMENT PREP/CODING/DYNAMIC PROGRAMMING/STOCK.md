...
timestamp: **12:06**  &emsp;  **21-06-2021**
topic tags: #dp
list tags: #must
resource: https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/discuss/108870/Most-consistent-ways-of-dealing-with-the-series-of-stock-problems
...
>**NOTE: See the submissions on leetcode for alternative approaches**
...
public:
    ...
    Since k is +infinity, k  and k-1 are same and we can buy only after cooldown
    ...
    */
    int maxProfit(vector<int>& prices) {
        ...
        int T_ik0 = 0, T_ik1 = INT_MIN, T_pik0 = 0;
        for(int p : prices){
            int temp = T_ik0; //temp is i-1th state for current p
            T_ik0 = max(T_ik0, T_ik1 + p);
            T_ik1 = max(T_ik1, T_pik0 - p);
            T_pik0 = temp;    //This becomes i-2th state for next p
        }
